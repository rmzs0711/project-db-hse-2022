...
Insert Into configs(id, configs_data) values (default, '{sensitivity = 2.0}');
INSERT INTO players(config_id, nickname, account_creation_date) values(3, 'RizzardOfOz', '2002-04-25');

Insert Into configs(id, configs_data) values (default, '{sensitivity = 1.3}');
INSERT INTO players(config_id, nickname, account_creation_date) values(4, 'LigmaBalls', '2002-04-25');

Insert Into configs(id, configs_data) values (default, '{sensitivity = 2.7}');
...
Insert Into configs(id, configs_data) values (default, '{sensitivity = 2.2}');
INSERT INTO players(config_id, nickname, account_creation_date) values(7, 'mrBEAST', '2002-04-25');

Insert Into configs(id, configs_data) values (default, '{sensitivity = 1.4}');
INSERT INTO players(config_id, nickname, account_creation_date) values(8, 'PDestroyer', '2002-04-25');

insert into music_tracks(id, track_data, track_name, author) values (default, '***first track data***','where' , 'pirat');
insert into music_tracks(id, track_data, track_name, author) values (default, '***second track data***','are' , 'domkrat');
insert into music_tracks(id, track_data, track_name, author) values (default, '***third track data***','the' , 'arbat');
insert into music_tracks(id, track_data, track_name, author) values (default, '***fourth track data***','money' , 'samokat');
insert into music_tracks(id, track_data, track_name, author) values (default, '***sixth track data***','lebovski' , 'standart');
insert into music_tracks(id, track_data, track_name, author) values (default, '***seventh track data***','damn mf hdik u mf' , 'azart');

insert into maps(id, music_id, map_data, author_id) values (default, 1, 'abc \153\154\155 \052\251\124'::bytea, 1);
insert into maps(id, music_id, map_data, author_id) values (default, 2, 'idkSOmememesasdadasdasdasdasdasd'::bytea, 2);
insert into maps(id, music_id, map_data, author_id) values (default, 3, 'коил коил коил'::bytea, 1);
insert into maps(id, music_id, map_data, author_id) values (default, 3, 'в моих глазах горит квазар'::bytea, 3);
insert into maps(id, music_id, map_data, author_id) values (default, 2, '21 ду сомесинг фор ми 21 ду ер сингс 21'::bytea, 2);
insert into maps(id, music_id, map_data, author_id) values (default, 4, 'итс э хард бит он э хард драйв'::bytea, 7);
insert into maps(id, music_id, map_data, author_id) values (default, 5, 'its a showdown on a back side'::bytea, 6);
insert into maps(id, music_id, map_data, author_id) values (default, 6, 'sadasfasfasfaxcbrjmjhndbuntrglcw,'::bytea, 5);
insert into maps(id, music_id, map_data, author_id) values (default, 3, 'qpntuodhfjikvoesmxcnlgewjcvoepvlnejdhv'::bytea, 4);
insert into maps(id, music_id, map_data, author_id) values (default, 4, 'chainsaw man is a good manga i really enjoyed with it'::bytea, 1);
